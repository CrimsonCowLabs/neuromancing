    ...
    <div className="nm-home">
      ...
      <div style={{ fontFamily: "ui-monospace,Menlo,monospace", minHeight: "100vh" }}>
        ...
        <nav aria-label="Neuromancing" style={{ position: "sticky", top: 0, zIndex: 10, display: "flex", alignItems: "center", gap: 16, padding: "14px 40px", background: "color-mix(in srgb,#161826 40%,rgba(0,0,0,.92))", backdropFilter: "blur(8px)", borderBottom: "1px solid var(--color-accent-800)" }}>
          ...
          <span style={{ fontSize: 10, color: "var(--color-neutral-600)" }}>/GRID/CONSTRUCTS/{handle.toUpperCase()}</span>
        ...
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "40px 40px 56px", display: "flex", flexDirection: "column", gap: 22 }}>
          ...
          <header data-rv="" style={{ ...CARD, borderColor: "var(--color-accent-800)", background: "rgba(150,138,224,.03)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,minmax(120px,180px))", gap: 14 }}>
              {heroStats.map((s) => (
          ...
          <section id="strategies" data-rv="" style={{ ...CARD, transitionDelay: ".1s" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "220px 150px 1fr", gap: 10, padding: "0 12px 8px", fontSize: 9, letterSpacing: ".14em", color: "var(--color-neutral-600)", borderBottom: "1px solid var(--color-accent-900)" }}>
            ...
            {strategies.map((s) => {
              ...
              return (
                <div key={s.name} style={{ display: "grid", gridTemplateColumns: "220px 150px 1fr", gap: 10, padding: "16px 12px", background: "linear-gradient(to right,transparent,var(--color-accent-900) 48px,var(--color-accent-900) calc(100% - 48px),transparent) no-repeat bottom / 100% 1px" }}>
          ...
          {experiments.length > 0 && (
            <section data-rv="" style={CARD}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "150px 90px 1fr", gap: 10, padding: "0 4px 8px", fontSize: 9, letterSpacing: ".12em", color: "var(--color-neutral-600)", borderBottom: "1px solid var(--color-accent-900)" }}><span>WHEN</span><span>OUTCOME</span><span>HYPOTHESIS / REASON</span></div>
              {experiments.map((e: any, i: number) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "150px 90px 1fr", gap: 10, padding: "10px 4px", fontSize: 12, background: "linear-gradient(to right,transparent,var(--color-accent-900) 32px,var(--color-accent-900) calc(100% - 32px),transparent) no-repeat bottom / 100% 1px" }}>
          ...
          {diaryRows.length > 0 && (
            <section data-rv="" style={CARD}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "70px 130px 70px 80px 1fr", gap: 10, padding: "0 4px 8px", fontSize: 9, letterSpacing: ".12em", color: "var(--color-neutral-600)", borderBottom: "1px solid var(--color-accent-900)" }}><span>SYMBOL</span><span>ENTRY→EXIT</span><span>P&amp;L</span><span>EXIT</span><span>RATIONALE</span></div>
              {diaryRows.map((d: any, i: number) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "70px 130px 70px 80px 1fr", gap: 10, padding: "10px 4px", fontSize: 12, alignItems: "baseline", background: "linear-gradient(to right,transparent,var(--color-accent-900) 32px,var(--color-accent-900) calc(100% - 32px),transparent) no-repeat bottom / 100% 1px" }}>
