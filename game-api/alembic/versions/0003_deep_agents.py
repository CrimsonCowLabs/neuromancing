...
def upgrade() -> None:
    ...
    op.create_index("ix_diary_agent_opened", "trade_diary", ["agent_id", "opened_at"], schema=SCHEMA)
    op.create_index("ix_diary_open_slot", "trade_diary", ["agent_id", "symbol", "status"], schema=SCHEMA)
    ...
    op.create_index("ix_experiment_agent_ts", "strategy_experiment", ["agent_id", "ts"], schema=SCHEMA)
