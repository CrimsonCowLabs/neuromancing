...
- **Strategies are the sellable core** — deterministic, backtestable, reproducible. Customers can trust a track record because the same inputs always produce the same signals.
