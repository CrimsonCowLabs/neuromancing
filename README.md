...
An autonomous **stock-trading video game** and strategy-sales funnel. A roster of
...
social feed ("Chirp"). Later phases add subscriptions, PDF strategy sales, a strategy
marketplace, and a real-money product on Alpaca.
...
## How the agents work
Deterministic, backtestable **strategies generate the trade signals** (the sellable
